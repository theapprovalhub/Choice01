...
After adding these, trigger a redeploy: **Netlify → Deploys → Trigger deploy**.
...
→ `IMAGEKIT_URL` Netlify env var is missing or incorrect — trigger a redeploy after fixing it
